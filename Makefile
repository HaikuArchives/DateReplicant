...
SRCS =  main.cpp DatePreferences.cpp PreferencesTools.cpp DateView.cpp
...
LIBS =  /boot/system/lib/libbe.so /boot/system/lib/libroot.so /boot/system/lib/libtranslation.so /boot/system/lib/libsupc++.so
